...
//@interface prueba_iosObject : NSObject
//@end

@interface prueba_iosObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[prueba_iosObject class]]) {
      for (NSString *key in [[(prueba_iosObject *)o modules] allKeys]) {
