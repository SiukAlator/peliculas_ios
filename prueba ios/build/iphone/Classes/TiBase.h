...
// in simulator we redefine to format for prueba_ios Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.prueba_ios." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.prueba_ios";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIprueba_iosNativeItemNone = -1,
  UIprueba_iosNativeItemSpinner = -2,
  UIprueba_iosNativeItemProgressBar = -3,

  UIprueba_iosNativeItemSlider = -4,
  UIprueba_iosNativeItemSwitch = -5,
  UIprueba_iosNativeItemMultiButton = -6,
  UIprueba_iosNativeItemSegmented = -7,

  UIprueba_iosNativeItemTextView = -8,
  UIprueba_iosNativeItemTextField = -9,
  UIprueba_iosNativeItemSearchBar = -10,

  UIprueba_iosNativeItemPicker = -11,
  UIprueba_iosNativeItemDatePicker = -12,

  UIprueba_iosNativeItemInfoLight = -13,
  UIprueba_iosNativeItemInfoDark = -14,

  UIprueba_iosNativeItemDisclosure = -15,

  UIprueba_iosNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all prueba_ios instances of
