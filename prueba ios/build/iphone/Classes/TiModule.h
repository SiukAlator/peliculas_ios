...
/**
 The base class for all prueba_ios modules
 */
...
/**
 prueba_ios Platform calls this method on startup.
 */
- (void)startup;

/**
 prueba_ios Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 prueba_ios Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 prueba_ios Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 prueba_ios Platform calls this method on resume.
 @param sender The sender of the event.
 */
