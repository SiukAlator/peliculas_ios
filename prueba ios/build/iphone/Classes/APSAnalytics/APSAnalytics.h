 ...
 * to send analytic data that can be viewed on the prueba_ios Dashboard.
 *
 * For information on getting started with prueba_ios Platform Services,
 * see [prueba_ios Platform Services for iOS](http://bit.ly/1kqteQS).
 */
