...
/**
 Base class for all prueba_ios views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the prueba_ios view hierarchy (such as wrapped iOS UIViews) was touched.
