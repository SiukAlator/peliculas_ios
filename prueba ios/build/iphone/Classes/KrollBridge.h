...
@interface prueba_iosObject : KrollCoverageObject {
#else
@interface prueba_iosObject : KrollObject {
#endif
  @private
...
extern NSString *prueba_ios$ModuleRequireFormat;
